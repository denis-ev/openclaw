import * as sessionClassification from "./session-classification.js";
...
export const SessionCoreProtocolSchemas = {
  ...
  SessionClassification: sessionClassification.SessionClassificationSchema,
  SessionPeerKind: sessionClassification.SessionPeerKindSchema,
